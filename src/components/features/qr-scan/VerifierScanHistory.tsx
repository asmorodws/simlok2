  ...
  return (
    <div className="space-y-6">
                        ...
                        <tr key={scan.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-4 py-4 text-sm" style={{width: '200px'}}>
                            <div>
                              ...
                              <div className="text-gray-500 truncate" title={scan.user.officer_name}>
                                {scan.user.officer_name}
                              </div>
                            </div>
                          </td>
      ...
      <ScanDetailModal
        ...
        scan={selectedScan ? convertQrScanToScanData(selectedScan) : null}
        title="Detail Scan QR Code"
        subtitle={getScanDetailSubtitle('VERIFIER')}
        showPdfButton={true}
