...
import VendorSubmissionDetailModal from "../modal/VendorSubmissionDetailModal";
...
export default function VendorSubmissionsContent() {
  ...
  useEffect(() => {
    const timeoutId = setTimeout(() => {
      ...
      if (paramsString === lastFetchParamsRef.current) {
        console.log('VendorSubmissions: Skipping duplicate fetch');
        return;
      }
  ...
  // Note: fetchVendorSubmissions tidak dimasukkan karena fungsi dari Zustand store yang stabil
  // lastFetchParamsRef adalah ref yang tidak trigger re-render
