...
export const RateLimitPresets = {
  ...
  userManagement: {
    windowMs: 60 * 1000, // 1 minute
    maxRequests: 10,
    message: 'Terlalu banyak operasi user management. Mohon tunggu sebentar.',
  },

  // Approval Actions: 20 approvals per minute
  approvalActions: {
    windowMs: 60 * 1000, // 1 minute
    maxRequests: 20,
    message: 'Terlalu banyak operasi approval. Mohon tunggu sebentar.',
  },

  // QR Verification: 30 scans per minute
  qrVerification: {
    windowMs: 60 * 1000, // 1 minute
    maxRequests: 30,
    message: 'Terlalu banyak scan QR. Mohon tunggu sebentar.',
  },

  // Dashboard Stats: 60 requests per minute (expensive queries)
  dashboardStats: {
    windowMs: 60 * 1000, // 1 minute
    maxRequests: 60,
    message: 'Terlalu banyak permintaan dashboard. Mohon tunggu sebentar.',
  },
} as const;
