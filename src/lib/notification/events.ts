...
export async function notifyAdminNewSubmission(submissionId: string) {
  try {
    ...
    try {
      ...
      console.warn('Failed to publish new admin notification to Redis:', err);
    }
...
export async function notifyAdminNewVendor(vendorId: string) {
  try {
    ...
    try {
      ...
      console.warn('Failed to publish new vendor notification to Redis:', err);
    }
...
export async function notifyVendorStatusChange(
  ...
  try {
    ...
    try {
      ...
      console.warn('Failed to publish vendor status change notification to Redis:', err);
    }
...
export async function notifyReviewerNewUser(userId: string) {
  try {
    ...
    try {
      ...
      console.warn('Failed to publish reviewer new user notification to Redis:', err);
    }
...
export async function notifyReviewerNewSubmission(submissionId: string) {
  try {
    ...
    try {
      ...
      console.warn('Failed to publish reviewer notification/new-count to Redis:', err);
    }
...
export async function notifyApproverReviewedSubmission(submissionId: string) {
  try {
    ...
    try {
      ...
      console.warn('Failed to publish approver reviewed notification to Redis:', err);
    }
...
export async function notifyReviewerSubmissionApproved(submissionId: string) {
  try {
    ...
    try {
      ...
      console.warn('Failed to publish reviewer approved notification to Redis:', err);
    }
...
export async function notifyVendorSubmissionRejected(
  ...
  try {
    ...
    try {
      ...
      console.warn('Failed to publish vendor rejection notification to Redis:', err);
    }
...
export async function notifyReviewerSubmissionResubmitted(
  ...
  try {
    ...
    try {
      ...
      console.warn('Failed to publish reviewer resubmission notification to Redis:', err);
    }
