      ...
      <div className="w-full max-w-lg">
        <Card className="p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="w-20 h-20 bg-warning-100 dark:bg-warning-500/20 rounded-full flex items-center justify-center mb-6">
          ...
          {/* User Info Card */}
          <Card className="bg-gray-50 dark:bg-gray-800/50 p-6 mb-6">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-brand-100 dark:bg-brand-500/20 rounded-full flex items-center justify-center flex-shrink-0">
          ...
          {/* Info Alert */}
          <div className="flex gap-3 p-4 bg-blue-light-50 dark:bg-blue-light-500/10 border border-blue-light-200 dark:border-blue-light-500/20 rounded-xl mb-8">
            <ExclamationTriangleIcon className="w-5 h-5 text-blue-light-500 flex-shrink-0 mt-0.5" />
            <div className="text-sm">
              <p className="text-blue-light-800 dark:text-blue-light-300 font-medium mb-1">
                Proses Verifikasi
              </p>
              <p className="text-blue-light-700 dark:text-blue-light-400">
